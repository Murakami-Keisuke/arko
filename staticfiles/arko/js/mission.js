...
var Missiondraw = function (_React$Component) {
  ...
  function Missiondraw(props) {
    ...
    _this.page_mission = props.page_mission;
  ...
  _createClass(Missiondraw, [{
    ...
    value: function Draw(block_id, API_host) {
      ...
      fetch(url).then(function (response) {
        ...
        _this2.page_mission.classList.add('page_show');
            ...
            React.createElement(
              'button',
              {
                ...
                , onClick: function onClick() {
                  ReactDOM.render(React.createElement(Historydraw, { room_id: j.id, API_host: _this3.API_host }), _this3.historycontainer);
                } },
